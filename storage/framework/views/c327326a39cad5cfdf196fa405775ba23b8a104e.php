                        ...
                        <ul class="nav side-menu">
                            <li><a><i class="fa fa-home"></i> Category <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                                    <li><a href="<?php echo e(url('admin/category')); ?>">List</a></li>
                                    <li><a href="<?php echo e(url('admin/category/add')); ?>">Add</a></li>
                                </ul>
                            </li>

                            <li><a><i class="fa fa-home"></i> Header  <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                                    <li><a href="<?php echo e(url('admin/header')); ?>">List</a></li>
                                    <li><a href="<?php echo e(url('admin/header/add')); ?>">Add</a></li>
                                </ul>
                            </li>

                            <li><a><i class="fa fa-home"></i> User <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                                    <li><a href="<?php echo e(url('admin/user')); ?>">List</a></li>
                                    <li><a href="<?php echo e(url('admin/user/add')); ?>">Add</a></li>
                                </ul>
                            </li>

                            <li><a><i class="fa fa-home"></i> Store <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                                    <li><a href="<?php echo e(url('admin/store')); ?>">List</a></li>
                                    <li><a href="<?php echo e(url('admin/store/add')); ?>">Add</a></li>
                                </ul>
                            </li>

                            <li><a><i class="fa fa-home"></i> Coupon <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                                    <li><a href="<?php echo e(url('admin/coupon')); ?>">List</a></li>
                                    <li><a href="<?php echo e(url('admin/coupon/add')); ?>">Add</a></li>
                                </ul>
                            </li>
